const SocialLinks = () => {
    const socialLinks = [
        {
            name: 'GitHub',
            url: 'https://github.com/raghav-kalyana-sundaram',
            icon: (
        ...
        {
            name: 'LinkedIn',
            url: 'https://www.linkedin.com/in/raghav-kalyan-4b7654287/',
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'Twitter',
            url: 'https://twitter.com/raghavkalyan',
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'YouTube',
            url: 'https://www.youtube.com/@raghavkalyan17',
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'Instagram',
            url: 'https://www.instagram.com/raghav._kalyan/',
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex justify-center md:justify-start space-x-4 mt-4">
            {socialLinks.map(link => (
                <a
                    ...
                    className="text-gray-500 hover:text-primary-link transition-colors duration-200 p-2 rounded-full hover:bg-gray-100"
